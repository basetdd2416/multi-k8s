...
docker build -t bluesaluman/multi-worker:latest -t bluesaluman/multi-worker:$SHA -f ./worker/Dockerfile ./worker

docker push bluesaluman/multi-client:latest
docker push bluesaluman/multi-server:latest
docker push bluesaluman/multi-worker:latest
